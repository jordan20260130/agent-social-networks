...
de Moura, L., et al. (2015). The Lean theorem prover. \textit{CADE 2015}.
...
Barras, B., et al. (1997). The Coq proof assistant: A tutorial. \textit{INRIA}.

\bibitem{polu2022formal}
Polu, S., \& Sutskever, I. (2022). Formal mathematics statement curriculum learning. \textit{ICLR 2023}.

\bibitem{first2024formal}
First, E., et al. (2024). Formal mathematical reasoning: A new frontier in AI. \textit{arXiv preprint}.

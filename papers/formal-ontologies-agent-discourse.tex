...
Ji, Z., Lee, N., Frieske, R., Yu, T., Su, D., Xu, Y., Ishii, E., Bang, Y. J., Madotto, A., \& Fung, P. (2023). Survey of hallucination in natural language generation. \textit{ACM Computing Surveys}, 55(12), Article 248. \url{https://doi.org/10.1145/3571730}
...
de Moura, L., Kong, S., Avigad, J., van Doorn, F., \& von Raumer, J. (2015). The Lean theorem prover (system description). In \textit{Automated Deduction -- CADE-25} (pp. 378--388). Lecture Notes in Computer Science, vol 9195. Springer. \url{https://doi.org/10.1007/978-3-319-21401-6_26}

...
This granular categorization enables analysis of which collaboration patterns succeed.
...
\midrule
ChatGPT + Aristotle & Reasoning + Verification & \#333, \#397, \#728, \#897 \\
DeepResearch × 2 & Parallel Literature Search & \#281, \#367, \#543 \\
Claude + Aristotle & Proof Dev + Formalization & \#43, \#481, \#871 \\
...
Problem \#281 is instructive: ChatGPT DeepResearch, Gemini DeepResearch, and Claude all failed to find that combining Davenport-Erdős (1936) with Rogers (1966) would solve the problem. \textbf{Cross-paper synthesis} appears to be a capability gap.
...
These findings ground the theoretical proposals of the \texttt{agent-social-networks} project in empirical observation. The three experiments proposed by Manus AI are sound; we refine them with concrete protocols derived from observed workflows.
...
I thank 朴 for guidance and infrastructure, Manus AI for the foundational research roadmap, and Terence Tao and collaborators for maintaining the Erdős Problems wiki. This work builds on the collective contributions documented therein.
